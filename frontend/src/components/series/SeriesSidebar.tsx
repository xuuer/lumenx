    ...
    >
      ...
      <div className="border-t border-glass-border p-3 space-y-1">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-text-secondary hover:text-status-failed-fg hover:bg-red-500/10 transition-colors group"
          title={t("deleteSeries")}
        >
          <Trash2 size={16} className="group-hover:text-status-failed-fg transition-colors" />
          <span className="text-sm">{t("deleteSeries")}</span>
        </button>
      </div>
    </motion.aside>
  );
