            ...
            if generation_type == "reference_sheet":
                ...
                for i in range(batch_size):
                    try:
                        ...
                        rel_path = os.path.relpath(sheet_path, "output").replace("\\", "/")
            ...
            if generation_type in ["all", "full_body"]:
                ...
                for i in range(batch_size):
                    try:
                        ...
                        rel_fullbody_path = os.path.relpath(fullbody_path, "output").replace("\\", "/")
            ...
            if generation_type in ["all", "three_view"]:
                ...
                for i in range(batch_size):
                    try:
                        ...
                        rel_sheet_path = os.path.relpath(sheet_path, "output").replace("\\", "/")
            ...
            if generation_type in ["all", "headshot"]:
                ...
                for i in range(batch_size):
                    try:
                        ...
                        rel_avatar_path = os.path.relpath(avatar_path, "output").replace("\\", "/")
    ...
    def generate_scene(self, scene: Scene, positive_prompt: str = None, negative_prompt: str = "", batch_size: int = 1, model_name: str = None, size: str = None) -> Scene:
        ...
        try:
            for _ in range(batch_size):
                ...
                rel_path = os.path.relpath(output_path, "output").replace("\\", "/")
